...
+ 5 String 🕸️
+ 1 Pet Crate 🪤
`, msg, { asLocation: true, buttons: [{buttonId: `.weekly`, buttonText: {displayText: 'Weekly'}, type: 1}, {buttonId: `.monthly`, buttonText: {displayText: 'Monthly'}, type: 1}], headerType: 4, footer: wm })
