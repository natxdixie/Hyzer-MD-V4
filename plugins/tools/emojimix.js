...
if (emo1.length > 1) return msg.reply(`🚩 Gunakan format ${usedPrefix + command} emoji1+emoji2\n\n*Contoh :* ${usedPrefix + command} 😁+😘`)
if (emo2.length > 1) return msg.reply(`🚩 Gunakan format ${usedPrefix + command} emoji1+emoji2\n\n*Contoh :* ${usedPrefix + command} 😁+😘`)
try {
